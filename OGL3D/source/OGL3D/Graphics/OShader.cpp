...
{
    m_programId = glCreateProgram(); // create general program, that will contain all our shaders
...
void OShader::attach(const wchar_t* fileName,const OShaderType& type)
{
   ...
   //Compile Vertex Shader
    ...
    glAttachShader(m_programId, shaderId); // let's attach this shader to the program
