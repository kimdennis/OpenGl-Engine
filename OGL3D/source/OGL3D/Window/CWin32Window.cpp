...
OWindow::OWindow()
{
	//Creating the Window with Win32 API -------
	//------------------------------------------
	...
	m_handle = CreateWindowEx(NULL, MAKEINTATOM(windowClassId), L"Overwatch 3", WS_OVERLAPPED | WS_CAPTION | WS_SYSMENU,
	...
	//Creating OpenGL 4.6 Render Context -------
	//------------------------------------------
